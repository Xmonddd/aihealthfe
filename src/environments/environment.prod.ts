...
<<<<<<< HEAD
  supabaseRedirectTo: 'http://localhost:4200/auth/callback', // adjust if deployed
=======
  supabaseRedirectTo: 'https://aihealthfe-4isq.vercel.app/auth/callback', // adjust if deployed

    apiUrl: 'https://aihealthbe.onrender.com'
